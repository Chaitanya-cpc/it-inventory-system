...
def get_db_connection(db_path=DEFAULT_DATABASE_PATH):
...
def initialize_database(conn=None, db_path=DEFAULT_DATABASE_PATH):
    """Creates or recreates the database tables."""
    ...
    # Drop existing tables (optional, for clean init) - Use with caution!
    # print("Dropping existing tables...")
    # cursor.execute("DROP TABLE IF EXISTS associated_info;")
    # cursor.execute("DROP TABLE IF EXISTS hardware_assets;")
    # cursor.execute("DROP TABLE IF EXISTS users;") # Drop users table too if recreating
    ...
    print("Creating hardware_assets table...")
    cursor.execute('''
    ...
    print("Creating associated_info table...")
    cursor.execute('''
    ...
    # --- Triggers --- (Ensure they exist)
    print("Creating/Verifying triggers...")
    cursor.execute('''
